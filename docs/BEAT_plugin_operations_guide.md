...
- 同じUUIDを運営と参加者の両方へ登録できます。この場合、競技中は参加者として扱われます。
...
8. 制限時間または全処理終了後、オンラインの参加者と運営はGameModeを維持したままEnd地点へ移動する。

運営だけに登録されたオンラインプレイヤーも練習開始時にCourse 1へ移動し、競技中のSidebar、BossBar、カウントダウン、全体Chatを受け取ります。順位と結果には含まれません。
...
6. 制限時間終了後、オンラインの参加者と運営はGameModeを維持したままEnd地点へ移動する。

運営だけに登録されたオンラインプレイヤーも開始時にStartへ移動し、Sidebar、BossBar、カウントダウン、全体Chatを受け取ります。順位と結果には含まれません。
...
5. Goalまたは制限時間終了後、オンラインの参加者と運営はGameModeを維持したままEnd地点へ移動する。

完走後に `fallY` 以下へ落ちた参加者は、Goal Progressに登録された先頭の座標へ戻ります。完走記録と順位は変わりません。

`admins.json` に登録された運営には、競技中の全Progressが空色の小型羊毛と番号で常時表示されます。
参加者の取得状況による色変化はなく、実況・監視用の固定表示です。
運営だけに登録されたオンラインプレイヤーも開始時にStartへ移動し、Sidebar、BossBar、カウントダウン、全体Chatを受け取ります。Zone 2・3到達は順位変動の有無に関係なく全体Chatへ表示されます。
...
| `/beat emergency force-end` | 現時点の記録で競技を終了・保存し、参加者と運営をEnd地点へ移動する |
